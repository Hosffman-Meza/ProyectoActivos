...
namespace WCF_DBADM
{
    ...
    public partial class ControlActivosEntitiesDavid : DbContext
    {
        public ControlActivosEntitiesDavid()
            : base("name=ControlActivosEntitiesDavid")
        {
        }
        ...
        public virtual ObjectResult<SP_ActTerreno_delete_Result> SP_ActTerreno_delete_Result(Nullable<int> noRegistroActivosTerrenos)
        {
            var noRegistroActivosTerrenosParameter = noRegistroActivosTerrenos.HasValue ?
                new ObjectParameter("NoRegistroActivosTerrenos", noRegistroActivosTerrenos) :
                new ObjectParameter("NoRegistroActivosTerrenos", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_ActTerreno_delete_Result>("SP_ActTerreno_delete_Result", noRegistroActivosTerrenosParameter);
        }
